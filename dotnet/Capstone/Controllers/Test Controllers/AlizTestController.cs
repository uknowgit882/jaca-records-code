...
namespace Capstone.Controllers
{
    [Route("[controller]")]
    [ApiController]
    public class AlizTestController : CommonController
    {
        public AlizTestController(IArtistsDao artistsDao, IBarcodesDao barcodesDao, ICollectionsDao collectionsDao, IFormatsDao formatsDao, 
