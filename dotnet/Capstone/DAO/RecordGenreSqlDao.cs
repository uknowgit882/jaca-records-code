...
namespace Capstone.DAO
{
    public class RecordGenreSqlDao : IRecordsGenresDao
    {
        ...
        public bool GetRecordGenreByRecordIdAndGenreId(int discogsId, int genreId)
        {
            ...
            {
                ErrorLog.WriteLog("Trying to get genre", $"For {discogsId}, {genreId}", MethodBase.GetCurrentMethod().Name, ex.Message);
        ...
        public bool AddRecordGenre(int discogsId, int genreId)
        {
            ...
            {
                ErrorLog.WriteLog("Trying to add genre", $"For {discogsId}, {genreId}", MethodBase.GetCurrentMethod().Name, ex.Message);
                throw new DaoException("exception occurred", ex);
            }
        }
